<html><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script src="register_files/analytics.js" type="text/javascript"></script>
<script type="text/javascript">window.addEventListener('DOMContentLoaded',function(){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app204.us.archive.org';v.server_ms=1099;archive_analytics.send_pageview({});});</script><script type="text/javascript" src="register_files/playback.js" charset="utf-8"></script>
<script type="text/javascript" src="register_files/wombat.js" charset="utf-8"></script>
<script type="text/javascript">
  __wm.init("https://web.archive.org/web");
  __wm.wombat("https://accounts.google.com/NewAccount","20111215180728","https://web.archive.org/","web","/_static/",
	      "1323972448");
</script>
<link rel="stylesheet" type="text/css" href="register_files/banner-styles.css">
<link rel="stylesheet" type="text/css" href="register_files/iconochive.css">
...
<script type="text/javascript">
      var onloadCallback = function() {
        grecaptcha.render('html_element', {
          'sitekey' : '6Ld3Ja8bAAAAAL2Jgd_hAMwDE6L35EAMXaMeRS9h'
        });
      };
    </script>
...
.recaptcha_is_showing_audio .recaptcha_only_if_image,.recaptcha_isnot_showing_audio .recaptcha_only_if_audio,.recaptcha_had_incorrect_sol .recaptcha_only_if_no_incorrect_sol,.recaptcha_nothad_incorrect_sol .recaptcha_only_if_incorrect_sol{display:none !important}</style></head>
  ...
  <body dir="ltr" onload="return(doKtInit());" vlink="#551a8b" text="#000000" link="#0000cc" bgcolor="#ffffff" alink="#ff0000"><!-- BEGIN WAYBACK TOOLBAR INSERT -->
<style type="text/css">
body {
  ...
  --></script>
  <script type="text/javascript">
  var KT_keydownHandler,KT_keypressHandler,KT_logEncoder,KT_lastElement=-1,KT_lastKeyCode=-1,KT_lastModifiers=-1,KT_logElement=0,KT_stoppedLog,KT_ALLOW_FIELD_TYPES={password:1,text:1},KT_ALLOW_FIELD_IDS={firstname:1,lastname:1,email:1,passwd:1,passwdagain:1,identityanswer:1,secondaryemail:1,newaccountcaptcha:0,nickname:1,gmailaddress:1,recoveryemailaddress:1,recoveryphonenumber:1},KT_lastTime,KT_inputs,KT_keyInputs=[];
window.captureEvents&&(Event.KEYPRESS&&window.captureEvents(Event.KEYPRESS),Event.KEYDOWN&&window.captureEvents(Event.KEYDOWN));function KT_preSubmit(){if(KT_logEncoder){KT_keydownHandler&&(KT_encode(16),KT_initHandlers(KT_inputs));var b=KT_logEncoder;if(0!=b.d)EN_encodeGroup(b,b.p),b.p=0}}function KT_encode(b){0>b?KT_stopLog():EN_encode(KT_logEncoder,b)}
function KT_init(b,c,d){KT_logElement=b;if(!b.value)b.value="A";KT_logEncoder={e:b,p:0,d:0};KT_initHandlers(d);if(!c.value)for(d=1;d<KT_keyInputs.length;d++)c.value+=KT_keyInputs[d].name+" "}
function KT_event(b,c){if(3E3<KT_logElement.value.length)KT_encode(17),KT_stopLog();else{var d;d=(new Date).getTime();var a=d-KT_lastTime;KT_lastTime=d;d=a;var a=b.k,e=b.t,f=b.m;b.m&3||(c|=2,65<=a&&90>=a?a=65:48<=a&&57>=a?a=48:c&1?97<=a&&122>=a?a=65:197==a||229==a?c&=5:192<=a&&687>=a?a=192:1536<=a?a=1536:912<=a?a=912:160<=a?a=160:127<=a?c&=5:33<=a?a=59:c&=5:48>a?c&=5:65>a?a=59:96>a?c&=5:112>a?a=96:187>a?c&=5:a=59);if(e!=KT_lastElement)KT_encode(c|4),KT_encode(e),KT_lastElement=e;else{if(a==KT_lastKeyCode&&
f==KT_lastModifiers){KT_encode(c|8);KT_encode(d);return}KT_lastKeyCode=a;KT_lastModifiers=f;KT_encode(c)}KT_encode(a);KT_encode(f);KT_encode(d)}}function KT_initHandlers(b){KT_keydownHandler=0;KT_inputs=b;KT_stoppedLog=0;for(var c=1,b=0;b<KT_inputs.length;b++){var d=KT_inputs[b];if(KT_ALLOW_FIELD_TYPES[d.type]&&!(d.id&&!KT_ALLOW_FIELD_IDS[d.id.toLowerCase()]||0==d.offsetHeight))d.onkeydown=KT_initKeyHandler,KT_keyInputs[c]=d,d.setAttribute("n",c++)}}
...
--></script>
<div class="header">
  <a href="https://web.archive.org/web/20111215180728/https://accounts.google.com/">
  <img class="logo" src="register_files/accounts_logo.gif" alt="Google Accounts">
...
<table width="700">
  ...
  <td>
  <font size="-1">
  If you already have a Google Account, you can <a href="https://web.archive.org/web/20111215180728/https://accounts.google.com/ServiceLogin">sign in here</a>.
  </font>
  </td>
  </tr>
</tbody></table>
<br>
  ...
  --></script>
  <form id="createaccount" name="createaccount" action="CreateAccount.php" method="post" onsubmit="return(onPreCreateAccountSubmit());">
  <input type="hidden" name="dsh" id="dsh" value="7567214829442135498">
  <input type="hidden" name="ktl" id="ktl" value="A qWeCKLARADm*QTQlK49NUN0Irx9wzfuN0fuWyfua1fuapunu739fzfupkunu739zzfuYlunYUN0y739SyfuQUN0o7396yfuQUN0e1RXIe.fmr4LapeTVqFXNNpfCtGVSKZ VGfx-HRzU*S62iEjDF0QQ*r.iue udlxkQTemmflJS Rau7TkE m9fyqOGHXdpoyg667IJbhTchiRIGDChKDnppyBKO8afKA_0Wk1QTRqLpb2uD5tZHTZE0QyopyREv lgJET9cd3Khd">
  <input type="hidden" name="ktf" id="ktf" value="Email Passwd PasswdAgain ">
  <table role="presentation" width="1%" cellspacing="0" cellpadding="2" bgcolor="white">
  <tbody><tr><td>
  <table role="presentation" width="1%" cellspacing="0" cellpadding="0" bgcolor="#fff">
  <tbody><tr><td>
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" bgcolor="#eeeeee">
  <tbody><tr><td valign="top" bgcolor="#ffffff" align="center">
  <table role="presentation" id="signupform" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
  <tbody><tr>
  ...
  <tr>
  <td style="padding-top:10px" valign="top" nowrap="nowrap"><span class="gaia sub el">Your username:</span></td>
  <td>
  <div>
  <input type="text" name="username" id="username" size="30" class="gaia sub emailtxtfield" n="1">
  <div role="alert" class="errormsg" id="ES_emailSuggestionBlock" style="display:none">
Did you mean <a href="javascript:ES_correctEmailField()"><span id="ES_suggestedEmail"></span></a>?
</div>
<div role="alert" class="errormsg" id="ES_emailErrorMessage" style="display:none">
</div>
<script type="text/javascript"> <!--

  function ES(b){if(document.getElementById)return document.getElementById(b);if(document.all)return document.all(b)}var ESa;function ESb(){ES("ES_emailSuggestionBlock").style.display="none"}function ESc(){ES("ES_emailErrorMessage").style.display="none"}function ESd(b){if(b=ES_Messages[b]){ESb();var c=ES("ES_emailErrorMessage");c.innerHTML=b;c.style.display="block"}else ESc()}
ES_spellCheckEmail=function(b,c,a){if(!a||a()){var d;try{d=document.forms[b][c].value}catch(e){if(e instanceof TypeError)return;throw e;}if(0!=d.length)if(a=/([^@]*)@(.*)/.exec(d))if(c=a[1],a=a[2],0==c.length)ESd("USERNAME_MISSING");else if(0==a.length)ESd("DOMAIN_MISSING");else if(0<=a.indexOf("@"))ESd("TOO_MANY_SEPERATORS");else{a:{d=[["generalmail.com","general-mail.com"],"bol.com.br,bol.com,bo.com.br,boi.com.br,bol.cm.br,bol.co.br,bol.com.be,bol.com.r,bol.combr,bola.com.br,boll.com.br,box.com.br,nol.com.br,ol.com.br,uol.com.br,vol.com.br".split(","),
"gmail.com,gmail.com.br,_gmail.com,g-mail.com,g.mail.com,g_mail.com,gamail.com,gamil.com,gemail.com,ggmail.com,gimail.com,gmai.com,gmail.cim,gmail.co,gmaill.com,gmain.com,gmaio.com,gmal.com,gmali.com,gmeil.com,gmial.com,gmil.com,gtmail.com,igmail.com".split(","),["hotmail.co.uk","hotmail.com.uk"],"hotmail.com,hotmail.com.br,hotmail.br,0hotmail.com,8hotmail.com,_hotmail.com,ahotmail.com,ghotmail.com,gotmail.com,hatmail.com,hhotmail.com,ho0tmail.com,hogmail.com,hoimail.com,hoitmail.com,homail.com,homtail.com,hootmail.com,hopmail.com,hoptmail.com,hormail.com,hot.mail.com,hot_mail.com,hotail.com,hotamail.com,hotamil.com,hotemail.com,hotimail.com,hotlmail.com,hotmaail.com,hotmael.com,hotmai.com,hotmaial.com,hotmaiil.com,hotmail.acom,hotmail.bom,hotmail.ccom,hotmail.cm,hotmail.co,hotmail.coml,hotmail.comm,hotmail.con,hotmail.coom,hotmail.copm,hotmail.cpm,hotmail.lcom,hotmail.ocm,hotmail.om,hotmail.xom,hotmail2.com,hotmail_.com,hotmailc.com,hotmaill.com,hotmailo.com,hotmaio.com,hotmaiol.com,hotmais.com,hotmal.com,hotmall.com,hotmamil.com,hotmaol.com,hotmayl.com,hotmeil.com,hotmial.com,hotmil.com,hotmmail.com,hotmnail.com,hotmsil.com,hotnail.com,hotomail.com,hottmail.com,hotymail.com,hoymail.com,hptmail.com,htmail.com,htomail.com,ohotmail.com,otmail.com,rotmail.com,shotmail.com".split(","),
"ig.com.br,ig.com,ieg.com.br,ig.com.brr,igb.com.br,igp.com.br,pig.com.br,rg.com.br".split(","),"rediffmail.com,reaiffmail.com,redffmail.com,redifemail.com,rediff.mail.com,rediffemail.com,rediffmai.com,rediffmaill.com,redifmail.com,redoffmail.com".split(","),"yahoo.co.in,yaho.co.in,yahoo.co.cn,yahoo.co.n,yahoo.co.on,yahoo.coin,yahoo.com.in,yahoo.cos.in,yahoo.oc.in,yaoo.co.in,yhoo.co.in".split(","),"yahoo.com.br,1yahoo.com.br,5yahoo.com.br,_yahoo.com.br,ayhoo.com.br,tahoo.com.br,uahoo.com.br,yagoo.com.br,yahho.com.br,yaho.com.br,yahoo.cm.br,yahoo.co.br,yahoo.com.ar,yahoo.com.b,yahoo.com.be,yahoo.com.ber,yahoo.com.bl,yahoo.com.brr,yahoo.com.brv,yahoo.com.bt,yahoo.com.nr,yahoo.coml.br,yahoo.con.br,yahoo.om.br,yahool.com.br,yahooo.com.br,yahoou.com.br,yaoo.com.br,yaroo.com.br,yhaoo.com.br,yhoo.com.br,yuhoo.com.br".split(","),
"yahoo.com,yahoomail.com,_yahoo.com,ahoo.com,ayhoo.com,eyahoo.com,hahoo.com,sahoo.com,yahho.com,yaho.com,yahol.com,yahoo.co,yahoo.con,yahoo.vom,yahoo0.com,yahoo1.com,yahool.com,yahooo.com,yahoou.com,yahoow.com,yahopo.com,yaloo.com,yaoo.com,yaroo.com,yayoo.com,yhaoo.com,yhoo.com,yohoo.com".split(",")];for(var a=a.toLowerCase(),h=d.length,f=0;f<h;f++)for(var i=d[f].length,g=1;g<i;g++)if(a==d[f][g]){a=d[f][0];break a}a=null}a?(c=c+"@"+a,ESc(),ES("ES_suggestedEmail").innerHTML=c,ES("ES_emailSuggestionBlock").style.display=
"block",ESa=b):(ESb(),ESc())}else ESd("SEPARATOR_MISSING")}};ES_correctEmailField=function(){if(ESa){var b=ES("ES_suggestedEmail").innerHTML;ESb();ESc();document.forms[ESa].Email.value=b}};ES_setupSpellCheck=function(b,c,a){try{var d=document.forms[b][c];d.onblur=function(){ES_spellCheckEmail(b,c,a)}}catch(e){if(!(e instanceof TypeError))throw e;}};

  ES_Messages = {
    
    DOMAIN_INVALID: 'Your email address contains the invalid domain name \x27%1\x27.',
    
    SEPARATOR_MISSING: 'Don\x27t forget to include the \x27@\x27.',
    
    TOO_MANY_SEPERATORS: 'Enter an email address with only one \x27@\x27.',
    
    USERNAME_MISSING: 'Enter a user name before the \x27@\x27.',
    
    DOMAIN_MISSING: 'Enter a domain name after the \x27@\x27.'
...
--> </script>
  ...
  <span class="gaia sub seex">
  e.g. myname@example.com. This will be used to sign-in to your account.
  </span>
  </td>
</tr>
  <tr><td style="padding-top:10px" valign="top" nowrap="nowrap"><label for="Passwd" class="gaia sub pl">Choose a password:</label><span>&nbsp;&nbsp;</span></td>
  <td>
  <table role="presentation" cellspacing="0" cellpadding="0">
  <tbody>
  <tr>
  <td><div>
  <input type="password" name="Passwd" id="Passwd" size="30" class="gaia sub passwdtxtfield" onkeyup="CreateRatePasswdReq('createaccount')" n="2">
  </div>
  <span class="gaia sub pc">Minimum of 8 characters in length.</span>
  <span class="gaia sub pc" id="passwordHelpLink" style="display:none;"><a href="https://web.archive.org/web/20111215180728/https://accounts.google.com/PasswordHelp" target="_blank" style="text-decoration:none;">[?]</a></span>
  <noscript>
  <span class="gaia sub pc"><a href="PasswordHelp" target="_blank" style="text-decoration:none;">[?]</a></span>
  </noscript>
  </td>
<script type="text/javascript" src="register_files/GaiaCaribou.js"></script>
<script type="text/javascript">
  <!--
  var myxmlhttp;
  ...
  XmlHttpPOST(myxmlhttp, `RatePassword?q=${passwd}`, params);
  }
  }
  ...
  <td width="10px"></td>
  <td id="passwdBarDiv" style="display: block;" width="180" valign="top" nowrap="nowrap">
  <table role="presentation" cellspacing="0" cellpadding="0">
  <tbody><tr>
  <td width="0" valign="top" nowrap="nowrap">
  <font size="-1" face="Arial, sans-serif">
  <a href="javascript:var popup=window.open('PasswordHelp', 'PasswordHelp',            'width=600, height=600, location=no, menubar=no,            status=no, toolbar=no, scrollbars=yes, resizable=yes');" tabindex="-1">
  Password strength:</a>
  </font>
  </td>
  <td valign="top" nowrap="nowrap">
  <font size="-1" face="Arial, sans-serif" color="#808080"><b>
  <div id="passwdRating"><font color="#aa0033">Weak</font></div>
  </b></font>
  </td>
  </tr>
  <tr>
  ...
  <tr>
  <td colspan="2">
  <table role="presentation" id="passwdBar" width="180" cellspacing="0" cellpadding="0" bgcolor="#ffffff"><tbody><tr>
  <td id="posBar" style="width: 45px; background: rgb(170, 0, 51) none repeat scroll 0% 0%;" width="0%" height="4" bgcolor="#e0e0e0"></td>
  <td id="negBar" style="width: 135px;" width="100%" height="4" bgcolor="#e0e0e0"></td>
  </tr></tbody></table>
  </td>
  </tr>
  </tbody></table>
...
//-->
  ...
  <label for="PasswdAgain" class="gaia sub rpl">
  Re-enter password:
  </label>
  </td>
  <td>
  <div>
  <input type="password" name="PasswdAgain" id="PasswdAgain" size="30" class="gaia sub passwdtxtfield" n="3">
  </div>
  </td>
  </tr>
  <tr>
...
<input type="hidden" name="rmShown" value="1"><label style="font-size: smaller;" for="PersistentCookie">Stay signed in
  </label>
  </td>
  </tr>
<tr>
  <td nowrap="nowrap">&nbsp;</td>
  <td align="left">
  <input type="checkbox" value="1" name="smhck" id="smhck" checked="checked">
  <input type="hidden" value="1" id="nshk" name="nshk">
  <label for="smhck" style="font-size: smaller;">
  Enable Web History
  <a href="https://web.archive.org/web/20111215180728/http://www.google.com/support/accounts/bin/answer.py?answer=54068&amp;hl=en" target="_blank">Learn More</a>
  </label>
  </td>
</tr>
  <tr>
...
<noscript>
  ...
  <select id="loc" name="loc" onchange="javascript:onLocChange()">
  <option value="AF">
  ...
  <noscript>
  <input type="submit" name="default_submit" id="default_submit" style="display:none"/>
  <input type="submit" name="change_location" id="change_location" style="display:inline" value="Change"/>
  </noscript>
  </td>
</tr>
  <tr id="AttrRowBirthday" style="display: table-row">
  <td id="AttrLabelCellBirthday" valign="top" nowrap="nowrap">
  ...
  MM/DD/YYYY (e.g. "12/15/2011")
  </span>
  </td>
  </tr>
<tr>
  <td valign="top">
  <label for="newaccountcaptcha" class="gaia cud cl">
  Word Verification:
  </label>
  </td>
  <td>
...
<script type="text/javascript">
  var RecaptchaState = {site:'6LeHF8USAAAAAOa_HdcHcf3ZR_-kUoehaUFfOcZW',challenge:'03AHJ_VuuwWveV5ET89zif8DrwYSeidjmjk9iFeK9TMS-OSc8TJAoNmDxVae7k8afM6DqoqCxrcEo5BinvPS10ikjjD0iHJENtEkGjmohp61eNMDtzsRF3scGc88z4-h4v4nqRAO0DvTE7JQ5ljbTJsQ478lXtEIxrAFyWjsm0yHAk1CL5jTPjmos',is_incorrect:false,programming_error:'',error_message:'error_message_value',server:'https://web.archive.org/web/20111215180728/https://www.google.com/recaptcha/api/',timeout:1800};
</script>
<script src="register_files/recaptcha.js" type="text/javascript"></script>
  </td>
  </tr>
  </tbody></table>
  </td>
  ...
  <td valign="top">
  <font size="-1" face="Arial, sans-serif">
  Please check the Google Account information you've entered above (feel
 free to change anything you like), and review the Terms of Service 
below.
  </font>
  </td>
  </tr>
...
<tr><td>
  <textarea rows="5" cols="80" style="width:100%;text-align:" readonly="readonly" onfocus="this.rows=10">﻿Google
 Terms of Service
...
may stop using the Services at any time. You do not need to specifically
 inform Google when you stop using the Services.
...
information you give to Google will always be accurate, correct and up 
to date.
...
maintaining the confidentiality of passwords associated with any account
...
7. Privacy and your personal information
 ...
 read Google’s privacy policy at http://www.google.com/privacy.html. 
...
whole or in part) unless you have been specifically told that you may do
 so by Google or by the owners of that Content, in a separate agreement.
...
the world those rights may exist). You further acknowledge that the 
Services may contain information which is designated confidential by 
Google and that you shall not disclose such information without Google’s
...
writing with Google, you agree that you are responsible for protecting 
and enforcing those rights and that Google has no obligation to do so on
 your behalf.
...
so, you may not assign (or grant a sub-license of) your rights to use 
...
in manner which clearly shows that you do not intend to, or are unable 
...
EXCLUDE OR LIMIT GOOGLE’S WARRANTY OR LIABILITY FOR LOSSES WHICH MAY NOT
 BE LAWFULLY EXCLUDED OR LIMITED BY APPLICABLE LAW. SOME JURISDICTIONS 
...
SERVICES IS AT YOUR SOLE RISK AND THAT THE SERVICES ARE PROVIDED "AS IS"
 AND “AS AVAILABLE.”
...
EXEMPLARY DAMAGES WHICH MAY BE INCURRED BY YOU, HOWEVER CAUSED AND UNDER
 ANY THEORY OF LIABILITY.. THIS SHALL INCLUDE, BUT NOT BE LIMITED TO, 
...
Millennium Copyright Act) and to terminating the accounts of repeat 
infringers. Details of Google’s policy can be found at 
...
<tr><td>
  <font size="-1">
  By clicking on 'I accept' below you are agreeing to the <a href="https://web.archive.org/web/20111215180728/https://accounts.google.com/TOS?loc=US&amp;hl=en" target="_blank">Terms of Service</a> above and the <a href="https://web.archive.org/web/20111215180728/http://www.google.com/intl/en/privacy/" target="_blank">Privacy Policy</a>.
  </font>
</td></tr>
</tbody></table>
<input type="hidden" id="privacy_policy_url" name="privacy_policy_url" value="http://www.google.com/intl/en/privacy/">
  <input type="hidden" id="requested_tos_language" name="requested_tos_language" value="en">
  <input type="hidden" id="served_tos_location" name="served_tos_location" value="US">
  <input type="hidden" id="served_tos_language" name="served_tos_language" value="en">
  </div>
  </div>
  </td>
  </tr>
<script src="register_files/XmlHttp.js" type="text/javascript"></script>
<script type="text/javascript" src="register_files/TimeZones.js"></script>
<script type="text/javascript"><!--
...
<div class="footer">
  ©2011 Google
  -
  <a href="https://web.archive.org/web/20111215180728/http://www.google.com/">Google Home</a>
  -
  <a href="https://web.archive.org/web/20111215180728/https://accounts.google.com/TOS?hl=en">Terms of Service</a>
  -
  <a href="https://web.archive.org/web/20111215180728/http://www.google.com/intl/en/privacy/">Privacy Policy</a>
  -
  <a href="https://web.archive.org/web/20111215180728/http://www.google.com/support/accounts?hl=en">Help</a>
</div>
...
<!--
     FILE ARCHIVED ON 18:07:28 Dec 15, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:27:59 Jul 21, 2021.
...
<!--
playback timings (ms):
  captures_list: 986.345
  exclusion.robots: 287.263
  exclusion.robots.policy: 287.255
  xauthn.identify: 116.052
  xauthn.chkprivs: 171.006
  RedisCDXSource: 5.885
  esindex: 0.005
  LoadShardBlock: 659.262 (3)
  PetaboxLoader3.datanode: 663.728 (4)
  CDXLines.iter: 15.211 (3)
  load_resource: 99.435
  PetaboxLoader3.resolve: 46.539
-->